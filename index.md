...
目前主要是把我的PVE系统折腾指南挂在这里，以及一些七七八八的教程  
...
```text
- 2026年5月3日
添加了用户代理检测来识别手机设备。这样可以确保在手机端不会加载 Live2D
修改了左右箭头切换文章的作用范围
为每篇文章添加了硬性东八时区，防止文章文件名生成时区问题
添加Immortalwrt详细刷机教程
一些文本修改
...
- 2026年4月7日
添加文章：PVE电源控制面板PLUS、Windows开机自动登录、Windows安装OpenSSH 
一些文本修改
...
- 2026年4月3日
采取更加合理的目录结构，使不同教程文章分开
修改目录阴影，添加默认展开设置
去除图片预览的文件检测
添加jekyll-sitemap与jekyll-seo-tag
添加tzinfo-data插件保证windows预览时区正确
为每篇文章撰写description字段
优化bing与google搜索
