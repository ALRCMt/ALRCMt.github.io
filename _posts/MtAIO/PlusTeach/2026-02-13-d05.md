---
title: 5.ServerBox设备监测器
author: ALRCMt
date: 2026-02-13 08:00:00 +08:00
category: Jekyll
layout: post
description: ServerBox 设备监测器安装配置教程，配合 Flutter Server Box 实现服务器状态图表展示，支持 iOS 桌面小组件查看 ImmortalWRT 状态。文章详细说明了 ServerBox 应用安装流程、服务器连接配置、监控指标选择以及通知提醒设置步骤，并提供 iOS 小组件添加方法、数据刷新频率调整、多设备管理等实用功能介绍，帮助用户随时随地通过手机查看服务器运行状态，实现便捷的远程运维监控。
---
...
注意记得删掉注释......本人的配置：[**config.json**](https://github.com/ALRCMt/MtAIO-Build/blob/main/immortalwrt/ServerBox/config.json)  
```shell
# 启用开机自启
